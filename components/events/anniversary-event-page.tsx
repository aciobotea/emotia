    ...
    <main className="flex-1">
      <section className="px-6 pb-16 pt-12 lg:px-10 lg:pb-24 lg:pt-18">
        <div className="mx-auto max-w-[88rem]">
          <div className="relative overflow-hidden rounded-[3rem] bg-[linear-gradient(145deg,rgba(255,252,246,0.98),rgba(245,235,207,0.9),rgba(227,199,141,0.72))] shadow-[0_32px_110px_rgba(126,88,24,0.12)]">
      ...
      <section className="px-6 pb-20 pt-8 lg:px-10 lg:pb-28 lg:pt-10">
        <div className="mx-auto max-w-[88rem] rounded-[2.7rem] border border-wine/14 bg-[linear-gradient(180deg,#741833,#531123)] px-8 py-10 text-paper lg:px-12 lg:py-14">
          ...
          <div className="-mx-8 mt-10 grid auto-cols-[8.5rem] grid-flow-col gap-3 overflow-x-auto px-8 pb-3 [scrollbar-width:none] md:mx-0 md:grid-flow-row md:grid-cols-2 md:gap-4 md:overflow-visible md:px-0 md:pb-0 [&::-webkit-scrollbar]:hidden">
