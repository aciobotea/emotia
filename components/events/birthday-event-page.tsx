  ...
  return (
    <main className="flex-1">
      ...
      <section className="px-6 py-8 lg:px-10 lg:py-12">
        <div className="mx-auto max-w-[88rem]">
          <div className="grid gap-6 lg:grid-cols-2">
            <div className="rounded-[2.8rem] border border-white/60 bg-[linear-gradient(145deg,rgba(255,250,246,0.95),rgba(245,235,225,0.82),rgba(232,215,198,0.66))] p-8 shadow-[0_24px_75px_rgba(96,74,54,0.08)] lg:min-h-[26rem] lg:p-12">
            ...
            <div className="rounded-[2.8rem] border border-white/60 bg-[linear-gradient(145deg,rgba(118,86,73,0.96),rgba(149,115,95,0.84),rgba(207,174,144,0.64))] p-8 shadow-[0_24px_75px_rgba(96,74,54,0.1)] lg:min-h-[26rem] lg:p-12">
      ...
      <section className="px-6 py-10 lg:px-10 lg:py-14">
        <div className="mx-auto max-w-[88rem] rounded-[3rem] border border-white/60 bg-[linear-gradient(145deg,rgba(255,250,246,0.95),rgba(244,233,223,0.82),rgba(231,214,198,0.66))] p-8 shadow-[0_28px_90px_rgba(96,74,54,0.11)] lg:p-12">
