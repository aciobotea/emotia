...
export function PricingPreviewSection() {
  return (
    <section id="pricing" className="px-6 py-18 lg:px-10 lg:py-24">
      <div className="mx-auto max-w-7xl rounded-[2.5rem] border border-wine/14 bg-[linear-gradient(180deg,#741833,#531123)] px-8 py-10 text-paper shadow-[0_24px_80px_rgba(91,35,56,0.18)] lg:px-12 lg:py-14">
        ...
        <div
          id="pricing-inquiry"
          className="mt-10 grid gap-8 rounded-[2.2rem] border border-white/10 bg-[linear-gradient(180deg,rgba(123,31,59,0.96),rgba(92,18,41,0.98))] p-6 shadow-[inset_0_1px_0_rgba(255,255,255,0.08),0_18px_52px_rgba(48,10,24,0.22)] lg:grid-cols-[0.78fr_1.22fr] lg:p-8"
        >
