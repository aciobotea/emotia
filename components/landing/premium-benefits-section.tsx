  ...
  return (
    <section id="benefits" className="relative overflow-hidden px-6 py-16 lg:px-10 lg:py-24">
      ...
      <div className="mx-auto max-w-[88rem]">
        <div className="relative overflow-hidden rounded-[2.75rem] border border-white/55 bg-[linear-gradient(135deg,rgba(255,252,247,0.96),rgba(237,231,223,0.9)_45%,rgba(208,196,179,0.76))] px-6 py-8 shadow-[0_30px_90px_rgba(91,35,56,0.13)] sm:px-8 lg:px-10 lg:py-10">
            ...
            <div className="mt-10 grid gap-5 xl:grid-cols-3">
              {benefits.map((benefit) => {
                ...
                return (
                  <Card
                    key={benefit.title}
                    className="relative overflow-hidden rounded-[2.1rem] border-white/55 bg-[linear-gradient(180deg,rgba(255,255,255,0.78),rgba(242,236,228,0.64))] shadow-[0_24px_55px_rgba(91,35,56,0.11)] backdrop-blur-sm"
                  >
                    <CardContent className="p-7 lg:p-8">
                      <div className="flex items-start justify-between gap-4">
                        <div className="flex h-14 w-14 items-center justify-center rounded-[1.2rem] border border-white/60 bg-[linear-gradient(180deg,rgba(255,255,255,0.92),rgba(235,228,217,0.78))] text-gold shadow-[0_10px_25px_rgba(139,31,65,0.18)]">
